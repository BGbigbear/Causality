...
def cot_deconstruct():
    with (
        open("../result/causality_test2_predict_rougeSFTcot_full_1.json", "r", encoding='utf-8') as f_cot,
        open("../result/causality_test2_predict_rougeSFTraw_full_1.json", "w", encoding='utf-8') as f_raw,
    ):
