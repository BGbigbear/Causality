...
test_file = '../data/initial/test1.json'
causality_file = '../data/reconstruction/merge1_1.json'

analysis_file = "./result/causality_test1_analysis_rougeSFT_full.json"
pred_file = './result/causality_test1_predict_rougeSFT_full.json'
