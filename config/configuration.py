...
test_file = './data/initial/test2.json'
...
# analysis_file = "./result/causality_test2cot_analysis_rougeSFT_full_0.json"
# pred_file = './result/causality_test2cot_predict_rougeSFT_full_0.json'
